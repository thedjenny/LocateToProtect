...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////
        //RoomListner r = new RoomListner();
       // r.checkRooms();
        FeneralSocketMethod ws = new FeneralSocketMethod();
        ws.socketSend();
        ...
        if(tokenManager.getToken().getAccessToken() != null){
            ...
            mail=tilEmail.getEditText().getText().toString();
            finish();
        }
    }
    ...
    void loginFacebook(){
     ...
     facebookManager.login(this, new FacebookManager.FacebookLoginListener() {
            ...
            public void onSuccess() {
                ...
                intent.putExtra("Username",  facebookManager.getUsername());
                mail = facebookManager.getUsername();
